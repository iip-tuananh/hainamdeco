...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'product', 'namespace'=>'Product'], function(){
		...
		Route::get('listtags/{id}','ProductController@listTags');
		Route::get('list_variant_sku/{id}','ProductController@listVariantSku');
	...
	Route::group(['prefix'=>'variant','namspace'=>"Variant"], function(){
		Route::post('list','VariantController@list');
		Route::post('create','VariantController@create');
		Route::get('edit/{id}','VariantController@edit');
		Route::get('delete/{id}','VariantController@delete');
		Route::get('get-value/{id}','VariantController@getValue');
	});
	...
	Route::post('listSloganbanner','BannerAdsController@listSlogan');
