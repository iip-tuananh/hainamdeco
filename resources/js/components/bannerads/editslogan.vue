            ...
            <div class="card">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <image-upload :oldImage="objData.image" v-model="objData.image" type="avatar" :title="'banner-'"></image-upload>
                </div>
                <div class="form-group">
                  <label>Tiêu đề</label>
                  <vs-input
                ...
                <div class="form-group">
                  ...
                  <vs-input
                    type="text"
                    size="default"
                    placeholder="Đường link cho banner"
                    class="w-100"
      ...
      addBanner(){
        ...
        if (this.errors.length > 0) {
          ...
          this.addBannerads(this.objData).then(response => {
            this.loadings(false);
            this.$router.push({name:'listBannerslogan'});
