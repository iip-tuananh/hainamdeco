        ...
        <div class="col-md-8 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row" v-for="(i, key) in bill.bill_detail" v-if="bill.bill_detail.length > 0" :key="key">
                <div class="col-md-1">
    ...
    addBills(){
      ...
      this.addBill(this.bill).then(response => {
        this.loadings(false);
         ...
         this.$notify.success('Thêm đơn hàng thành công');
      }).catch(error => {
        this.loadings(false);
        this.$notify.error('Thêm đơn hàng thất bại');
      })
    },
    listProducts(){
      this.loadings(true);
