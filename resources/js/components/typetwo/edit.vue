      ...
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-3"><h4 class="card-title">Sửa danh mục cấp 2</h4></div>
...
export default {
  ...
  methods: {
    ...mapActions(["getInfoTypeTwo","saveTypeTwo","listLanguage", "loadings",'listCate','findTypeCate']),
    nameImage(event) {
    ...
    saveEdit() {
      ...
      if (this.errors.length > 0) {
        ...
        .then(response => {
          ...
          .catch(error => {
            this.loadings(false);
            // this.$notify.error('Sửa danh mục thất bại');
          });
      }
    },
    listLang(){
    ...
    getInfoCates(){
      this.loadings(true);
      this.getInfoTypeTwo(this.objData).then(response => {
        this.loadings(false);
